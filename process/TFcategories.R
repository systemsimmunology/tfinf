##
##
## Rough divisions of TFs for prioritization
##
...
po.dir <- file.path(Sys.getenv("TFINF"),"data/process_output")
...
load(paste(po.dir,"tteMaps.RData",sep="/"))
...
ofile <- paste(po.dir,"ttfEcluster.tsv",sep="/")
write.table(file=ofile,
...
ofile <- paste(po.dir,"ttfEpwms.tsv",sep="/")
write.table(file=ofile,
...
ofile <- paste(po.dir,"TFcategories.RData",sep="/")
