...
load(paste(out.dir,"SingleFeatures.RData",sep="/"))
load(paste(out.dir,"PairedFeatures.RData",sep="/"))
load(paste(out.dir,"featureMatrix.RData",sep="/"))
...
ofile <- paste(out.dir,"sigPairedSitesBC.RData",sep="/")
