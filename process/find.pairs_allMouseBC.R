...
##
## Contains "tally"s, results of which may not be in current use
...
## Save feature
save(mdof,file=paste(out.dir,"mdof.RData",sep="/"))
ofile <- paste(out.dir,"hitTally.allMouse.RData",sep="/")
...
save(featureMatrix.mf,file=paste(out.dir,"featureMatrix.mf.RData",sep="/"))
...
save(featureMatrix,file=paste(out.dir,"featureMatrix.RData",sep="/"))
