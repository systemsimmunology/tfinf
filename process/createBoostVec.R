...
load(paste(Sys.getenv("PO_DIR"),"TFcategories.RData",sep="/"))
load(paste(Sys.getenv("EXP_DIR"),"representativeProbes.RData",sep="/"))
load(paste(Sys.getenv("AUX_DIR"),"boost.vec.refit.RData",sep="/"))
...
save(boost.vec,file=paste(Sys.getenv("PO_DIR"),"boost.vec.RData",sep="/"))
